            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-9">
                    <div class="ablums-text text-center mb-70">
                        <p>Misc is a form art,an expression of emotions through harmonic frequencies.most music includes people singing with their voices or playing muscial instruments,such as the piano,guiter</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-end">
                ...
                <div class="col-12 col-md-7 col-lg-8">
                    <div class="featured-artist-content">
                        ...
                        <div class="song-play-area">
                            <div class="song-name">
                                <p>02. Main Hit Song-<em>bailemos</em></p>
                            </div>
                            <audio preload="auto" controls>
                ...
                <div class="col-12 col-lg-4">
                    <div class="popular-artists-area mb-100">
                        ...
                        <div class="single-artists d-flex align-items-center wow fadeInUp" data-wow-delay="250ms">
                            ...
                            <div class="content-">
                                <p>Dimitry vegas and Like Mike</p>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group wow fadeInUp" data-wow-delay="300ms">
                                        <input type="text" class="form-control" id="subject" name="subject1" placeholder="Subject">
                                    </div>
                                </div>
                                <div class="col-12">
