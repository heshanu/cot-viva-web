...
<head>
    ...
    <title>tommrowland-homepage</title>
                    ...
                    <div class="single-event-area mb-30">
                        ...
                        <div class="event-text">
                            ...
                            <div class="event-meta-data">
                                ...
                                <a href="#" class="event-date">June 15, 2020</a>
                            </div>
                    ...
                    <div class="single-event-area mb-30">
                        ...
                        <div class="event-text">
                            ...
                            <div class="event-meta-data">
                                ...
                                <a href="https://www.ibiza.com" class="event-date">June 15, 2020</a>
                            </div>
                            <a href="#" class="btn see-more-btn">See Event</a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-event-area mb-30">
                        ...
                        <div class="event-text">
                            <h4>Dj Night Party</h4>
                            <div class="event-meta-data">
                                <a href="#" class="event-place">tommrowland</a>
                                <a href="#" class="event-date">June 15, 2020</a>
                            </div>
                             <h1>get excited!  <a href="https://www.tomorrowland.com/global/">visit here</a> </h1>
                            <a href="#" class="btn see-more-btn">See Event</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-event-area mb-30">
                        ...
                        <div class="event-text">
                            <h4>ultra</h4>
                            <div class="event-meta-data">
                                <a href="https://ultramusicfestival.com" class="event-place">Gold Arena</a>
                                <a href="#" class="event-date">June 15, 2020</a>
                            </div>
                            <a href="#" class="btn see-more-btn">See Event</a>
                        </div>
